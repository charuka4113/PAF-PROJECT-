...
public class CartService {
	...
	//           GBService/CartManagement/getItems
	...
	//Read the values from the JSON object
	 ...
	 String productid = cartObject.get("cartid").getAsString();

	 String output = cart.updateInventory(cartData, productname, description, size, price, type); //ERRRors
	return output; 
	}
